...
export default function CartPage() {
  ...
  const handleProceedToCheckout = async () => {
    ...
    // Save cart total to session storage for checkout page
    sessionStorage.setItem('checkoutTotal', cartTotal.toString());
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-4">
            {items.map((item) => (
              <div key={item.id} className={`bg-white rounded-2xl p-5 shadow-sm border ${
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 sticky top-24">
              ...
              <div className="flex justify-between pt-4 mb-6">
                ...
                <span className="text-2xl font-bold text-green-600">{formatETB(cartTotal)}</span>
              </div>
