  ...
  const testimonials = [
    {
      name: "Biruk Tesfaye",
      role: "Farmer, Oromia",
      content: "AgriSmart AI has transformed how I sell my produce. The price predictions helped me get 30% more profit!",
      rating: 5,
      image: "👨‍🌾"
    },
    {
      name: "Meron Alemu",
      role: "Buyer, Addis Ababa",
      content: "Finally a platform where I can find fresh, quality produce directly from farmers. Highly recommended!",
      rating: 5,
      image: "👩‍💼"
    },
    {
      name: "Dr. Tadesse Gebre",
      role: "Agricultural Economist",
      content: "The AI price intelligence is remarkably accurate. A game-changer for Ethiopian agriculture.",
      rating: 5,
      image: "👨‍🎓"
    },
  ];
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Trusted by thousands of farmers and buyers across Ethiopia
            </p>
          </div>
