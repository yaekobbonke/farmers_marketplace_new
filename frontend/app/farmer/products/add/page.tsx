...
export default function AddProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // ✅ Only send fields that exist in the Product model
      const payload = {
        name: formData.name,
        ...
        // status field is not in Product model, so don't send it
      };
        ...
        <div className="bg-white rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
          {success ? (
            <div className="py-32 text-center animate-in fade-in zoom-in duration-700">
              ...
              <p className="text-slate-500 font-medium mt-4">Your product is pending admin approval...</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 md:y-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full p-5 md:p-6 bg-slate-50 border-2 border-transparent focus:border-green-500/10 focus:bg-white rounded-2xl md:rounded-3xl focus:ring-4 focus:ring-green-500/5 outline-none text-base md:text-lg font-bold transition-all cursor-pointer"
