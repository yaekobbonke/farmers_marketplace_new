...
export default function ReviewOrderPage() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const orderData = {
        ...
        notes: `Payment Method: ${checkoutData?.paymentMethod} | Phone: ${checkoutData?.phone} | Email: ${checkoutData?.email} | Delivery Fee: ${deliveryFee} ETB | System Fee (0.5%): ${systemFee.toFixed(2)} ETB | Tax (5%): ${taxFee.toFixed(2)} ETB`,
      };
  ...
  const displayTaxFee = subTotal * TAX_PERCENTAGE;
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="space-y-4">
                {cartItems.map((item: any, index: number) => (
                  <div key={`item-${item.id}-${index}`} className="flex justify-between items-center pb-4 border-b border-slate-100 last:border-0">
                    <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 sticky top-24">
              ...
              <div className="space-y-3 pb-4 border-b border-slate-100">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{formatETB(displayTaxFee)}</span>
                </div>
              </div>
